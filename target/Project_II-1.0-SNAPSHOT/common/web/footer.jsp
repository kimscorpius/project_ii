            ...
            <div class="row">
                ...
                <div class="col-md-4 md-margin-bottom-40">
                    ...
                    <ul class="list-unstyled address-list margin-bottom-20">
                        <li><i class="fa fa-angle-right"></i>Bac Ninh - Viet Nam</li>
                        <li><i class="fa fa-angle-right"></i>Phone: 0965.146.537</li>
                        <li><i class="fa fa-angle-right"></i>Hotline: 03333 666 999</li>
                        <li><i class="fa fa-angle-right"></i>Email:
                            kimscorpius@gmail.com</li>
                    </ul>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>
                        2021 &copy; Development by kimscorpius <a target="_blank"
                                                             href="https://www.facebook.com/kimscorpius/">Follow Me</a> | <a
