...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li><a href="${pageContext.request.contextPath }/admin/products"><i class="fa fa-desktop fa-3x"></i>
                Product Management</a></li>
            <li><a href="${pageContext.request.contextPath }/admin/users"><i class="fa fa-qrcode fa-3x"></i>
                USER Management</a></li>
            <li><a href="${pageContext.request.contextPath }/admin/order/list"><i
                    class="fa fa-bar-chart-o fa-3x"></i>
...
<%--            <li><a href="/admin/blank"><i class="fa fa-square-o fa-3x"></i>--%>
