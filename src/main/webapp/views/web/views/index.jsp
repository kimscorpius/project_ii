...
<head>
    <meta charset="UTF-8">
    <title>Cửa hàng Laptop uy tín hàng đầu Việt Nam</title>
...
<div class="wrapper">
    ...
    <div class="container content-md">
        ...
        <div class="heading heading-v1 margin-bottom-40">
            <a href="<c:url value="/laptop-sinh-vien-van-phong"/> ">
        ...
        <div class="row illustration-v2">
            ...
            <c:forEach items="${productsHTVP }" var="p">
        ...
        <br><br>
        <div class="heading heading-v1 margin-bottom-40">
            <a href="<c:url value="/laptop-do-hoa"/> ">
        ...
        <div class="row illustration-v2">
            ...
            <c:forEach items="${productsDHKT }" var="p">
                <c:url value="${p.image }" var="imgUrl"></c:url>
        ...
        <br><br>
        <div class="heading heading-v1 margin-bottom-40">
            <a href="<c:url value="/laptop-gaming"/> ">
                <h2>LAPTOP GAMING</h2>
            </a>
        </div>
        ...
        <div class="row illustration-v2">
            ...
            <c:forEach items="${productsLGM }" var="p">
                <c:url value="${p.image }" var="imgUrl"></c:url>
        ...
        <br><br>
        <div class="heading heading-v1 margin-bottom-40">
            <a href="<c:url value="/cao-cap-sang-trong"/> ">
        ...
        <div class="row illustration-v2">
            ...
            <c:forEach items="${productsCCST }" var="p">
                <c:url value="${p.image }" var="imgUrl"></c:url>
