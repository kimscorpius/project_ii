...
<head>
    ...
    <title>Đơn hàng của quý khách</title>
    <!-- Favicon -->
                    ...
                    <section>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${userOrderedList}" var="ordered">
                                        <p>Mã đơn hàng: ${ordered.getId()}, Ngày mua: ${ordered.getBuyDate()},
                                            Tổng tiền thanh toán: ${ordered.getPrice()}Đ</p>
                                        <c:forEach items="${ordered.getCartItemList()}" var="orderItem">
                                                <tr>
