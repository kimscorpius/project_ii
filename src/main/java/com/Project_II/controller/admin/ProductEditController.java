...
public class ProductEditController extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Product product = productService.findOne(Integer.parseInt(request.getParameter("id")));
        request.setAttribute("product", product);
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/views/admin/views/edit-product.jsp");
        ...
        try {
            ...
            for (FileItem item : items) {
                ...
                switch (itemName) {
                    ...
                    case "id" : product.setId(Integer.parseInt(itemConcept)); break;
                }
            }
